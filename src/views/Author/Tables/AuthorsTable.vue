                ...
                <template v-slot:default="row">
                    <th scope="row">
                        <div class="media align-items-center">
                            <router-link :to="{ name: 'author', params: { id: row.item.id } }" class="avatar rounded-circle mr-3">
                                <img :src="row.item.avatar ? row.item.avatar : 'img/theme/default-placeholder.png'" alt="Author Avatar" />
                            </router-link>

                            <div class="media-body">
                                <span class="name mb-0 text-sm">
                                    <router-link :to="{ name: 'author', params: { id: row.item.id } }">
                                        {{ row.item.name }}
                                    </router-link>
                                </span>
                            </div>
